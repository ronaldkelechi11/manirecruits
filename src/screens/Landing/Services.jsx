            ...
            <div className="h-full w-full grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-8 justify-items-center items-center">
                ...
                <div className="rounded-lg w-full min-h-[30vh] md:min-h-[50vh] bg-gray-200 md:hover:scale-105 transition p-5 md:p-10 flex flex-col justify-between">
                    <div className="flex flex-col">
                        <p className="text-2xl text-gray-900 font-poppins">Staff</p>
                        <p className="text-2xl text-gray-500 font-poppins font-extrabold group-hover:bg-gray-900">Recruitment</p>
                    </div>
                ...
                <div className="rounded-lg w-full min-h-[30vh] md:min-h-[50vh] bg-gray-200 md:hover:scale-105 transition p-5 md:p-10 flex flex-col justify-between">
                    <div className="flex flex-col">
                        <p className="text-2xl text-gray-900 font-poppins">Staff</p>
                        <p className="text-2xl text-gray-500 font-poppins font-extrabold group-hover:bg-gray-900">Training</p>
                    </div>
