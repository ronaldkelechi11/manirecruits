...
const Navbar = () => {
    ...
    return (
        <div className='h-auto bg-primary w-full p-2 flex flex-wrap items-center justify-between'>
            <NavLink
                reloadDocument
            ...
            <div className="md:hidden p-2 transition-all cursor-pointer text-white" onClick={toggleNav}>
                {isOpen ?
                    "X" :
                    "="
                }
